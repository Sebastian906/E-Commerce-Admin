...
const Add = () => {
    return (
        <form className='flex flex-col w-full items-start gap-3 text-stone-800'>
            <div>
            ...
            <div className='w-full'>
                ...
                <input className='w-full max-w-[500px] px-3 py-2 bg-transparent' type="text" placeholder='Escriba aquí' required/>
            </div>
            <div className='w-full'>
                <p className='mb-2'>Descripción del Producto</p>
                <textarea className='w-full max-w-[500px] px-3 py-2 bg-transparent' type="text" placeholder='Escriba aquí' required/>
            </div>
